/**
 * Canvas Element Validator
 *
 * Validates element configurations before they are added to Canvas.
...
/**
 * Validates a canvas element configuration
 * @param {Object} element - The element to validate
 * @returns {Object} { valid: boolean, error?: string }
 */
export const validateCanvasElement = (element) => {
 ...
 * @returns {string[]}
 */
export const getSupportedElementTypes = () => Object.keys(ELEMENT_TYPES);
 ...
 * @returns {boolean}
 */
export const isElementTypeSupported = (type) => type in ELEMENT_TYPES;
